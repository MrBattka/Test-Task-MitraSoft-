    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.wrapperAboutMe}>
        <div className={styles.aboutMe}>
          ...
          <p>
            С 2021г заинтересовался разработкой сайтов и в свободное время начал
            активно изучать направление frontend разработчика. Все изучал
            самостоятельно при помощи книг и курсов в открытом доступе. Сейчас
            пишу веб-приложение социальная сеть с помощью связки react-redux.
            Поверхностно знаком с typescript. Есть опыт работы с React-Native.
            Хочу быстрее развиваться и для этого ищу профессиональную команду с
            хорошим лидером.
          </p>
          <p>
            <p>
            ...
            <div>
              <p>
                Git Pages:{" "}
                <a href="https://mrbattka.github.io/Test-Task-MitraSoft-/">
                  https://mrbattka.github.io/Test-Task-MitraSoft-/
                </a>
              </p>
              <p>
                Git Repositories:{" "}
